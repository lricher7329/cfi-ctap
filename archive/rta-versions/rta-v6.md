...
By 2031, CTAP will: achieve Alberta FAST 45-day trial startup (vs. 9-12 month Canadian average); reduce trial planning-to-activation by 40-50%; double recruitment efficiency with 15% Indigenous/20% rural targets; enable 5+ first-in-human trials and 3+ cell therapy trials; integrate biospecimens with 70%+ trials; deploy 8 CRAIDL agents nationally via ACT-AEC; serve as Western anchor for ACT-AEC, PRAIRIE Hub, RareKids-CAN (20+ sites, 100+ OHDSI institutions); and train 150+ HQP (20% from underrepresented groups).
...
3. Hepatitis C & Vaccine Trials: Nobel laureate Michael Houghton's hepatitis C vaccine challenge trials (Health Canada reviewed); controlled human infection model (CHIM) facility supporting PRAIRIE Hub vaccine programs with focus on non-airborne pathogens (blood-borne HCV, enteric pathogens) using BSL-2 standard containment.
...
Key Partnerships: Amii (10+ CIFAR AI Chairs, CRAIDL Partnership); Connect Care/AHS (provincial EMR); AWS Canada ($500k+ credits, Calgary region); API; iSMART (Mushahwar, CRC Tier 1, GLP device validation).
...
Suite 1a - Vaccine Challenge Trial Unit ($340,000): Controlled human infection model (CHIM) facility supporting Dr. Michael Houghton's hepatitis C vaccine program and PRAIRIE Hub vaccine candidates. This non-airborne-focused design supports blood-borne pathogens (HCV—Houghton's Nobel Prize-winning research) and enteric pathogens using BSL-2 standard containment with enhanced monitoring, extended-stay capability, and dedicated pathogen preparation areas. The non-airborne design reduces infrastructure requirements while enabling scientifically rigorous challenge studies aligned with PRAIRIE Hub vaccine development priorities.
...
Components: Renovations & fit-out ($800,000), Challenge Unit renovation & equipment ($340,000), monitoring equipment ($400,000), POC laboratory ($200,000), IP pharmacy ($300,000), Autonomic Function Labs ($261,000), Pediatric Unit ($170,000), ADI CRU bariatric/metabolic equipment ($128,000), services ($30,000).
...
## Suite 4: Data Platform, Secure Environments, AI/HPC ($1,780,000)
...
**Amii CRAIDL Partnership ($650,000):** CTAP includes dedicated funding for an Amii CRAIDL Partnership—enabled through strategic reallocation from Suite 1's Challenge Trial Unit (non-airborne design reduces infrastructure requirements). This partnership embeds dedicated Amii personnel (2.0 FTE: 1.0 ML Engineer, 1.0 Research Scientist), AI fellowship positions (2 graduate student positions at 0.5 FTE each), and priority SDRE compute access within CTAP, accelerating CRAIDL development by 6-9 months per agent. The partnership leverages Amii's established partnerships with AHS and Connect Care, production-scale clinical AI deployment experience (AI Scribe), and deep expertise in healthcare AI—all without requiring CTAP to independently develop this capacity. Per Amii's letter of support, this represents a commitment to dedicated CRAIDL development capacity rather than ad-hoc consulting.
...
- Suite 1 (Clinical Trials Infrastructure): $82,000/year, $410,000 over 5 years (5% rate)
...
- Suite 4 (Data Platform & AI/HPC): $213,600/year, $1,068,000 over 5 years (12% rate)
- Suite 5 (Trial Innovation): $54,080/year, $270,400 over 5 years (8% rate)
- TOTAL: $621,730/year, $3,108,650 over 5 years
...
CTAP infrastructure requires specific HSE considerations: biobanking with ultra-low freezers requiring backup power and monitoring; GMP cleanrooms requiring validated environmental controls; challenge trial isolation rooms requiring enhanced monitoring and pathogen handling procedures for BSL-2 containment; and autonomic function laboratories requiring participant safety protocols during tilt testing. CTAP will work with Environmental Health & Safety and Facilities Management to ensure compliance with institutional and regulatory requirements.
